...
import { EuiCallOut, EuiComboBox, EuiComboBoxOptionOption, EuiFormRow, EuiSpacer, EuiText, EuiTitle } from '@elastic/eui';
import { getExceptionBuilderComponentLazy } from '@kbn/lists-plugin/public';
import { CreateExceptionListItemSchema, ExceptionListItemSchema, ExceptionListType, OsType, OsTypeArray } from '@kbn/securitysolution-io-ts-list-types';
import { ExceptionsBuilderExceptionItem } from '@kbn/securitysolution-list-utils';
import { DataViewBase } from '@kbn/es-query';import { hasEqlSequenceQuery, isEqlRule } from '@kbn/security-solution-plugin/common/detection_engine/utils';
...
interface ExceptionsFlyoutMetaComponentProps {
  ...
  handleFilterIndexPatterns: (patterns: DataViewBase, type: ExceptionListType, osTypes?: ("linux" | "macos" | "windows")[] | undefined) => DataViewBase;
}
