...
import { createExceptionItemsReducer, State } from '../common/reducer';
import { ExceptionsConditions } from '../common/exception_flyout_conditions';
import { ExceptionItemsFlyoutAlertOptions } from '../common/exception_flyout_alert_options';
import { ExceptionsFlyoutComments } from '../common/exceptions_flyout_comments';
import { ExceptionsAddToLists } from '../common/exception_flyout_lists_options';
...
export const AddExceptionFlyout = memo(function AddExceptionFlyout({
  ...
  const { isLoading, rule: maybeRule, indexPatterns } = useFetchExceptionFlyoutData({
    ruleId,
  });
  ...
  useEffect((): void => {
    if (exceptionListType === 'endpoint' && hasAlertData) {
      setExceptionItemsToAdd(defaultEndpointExceptionItems(ENDPOINT_LIST_ID, maybeRule?.name, alertData));
    } 
          ...
          <FlyoutBodySection>
              ...
              />
               ...
               <ExceptionsConditions
                ...
                showOsTypeOptions={exceptionListType === 'endpoint' && !hasAlertData}
              />
