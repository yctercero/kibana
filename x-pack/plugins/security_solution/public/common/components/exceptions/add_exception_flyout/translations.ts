...
export const CANCEL = i18n.translate('xpack.securitySolution.exceptions.createExceptionItem.cancel', {
...
export const VIEW_LABEL = i18n.translate('xpack.securitySolution.exceptions.createExceptionItem.viewLabel', {
  defaultMessage: 'View',
});
